...
import '../bloc/abstract_bloc.dart';
import '../bloc/base_states.dart';

abstract class BasePage<B extends AbstractBloc> extends StatefulWidget {
  const BasePage({super.key});

}

abstract class PageState<B extends AbstractBloc> extends State<BasePage<B>> {
  late B bloc;
