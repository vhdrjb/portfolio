...
part of 'last_careers_mobile_component.dart';

// **************************************************************************
// WidgetComponentGenerator
// **************************************************************************

abstract class _$LastCareersMobileComponent extends StatelessWidget {
  const _$LastCareersMobileComponent({Key? key});
